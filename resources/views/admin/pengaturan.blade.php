                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('admin.pengaturan.submit') }}">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="username" class="form-control" name="username" value="{{ Auth::user()->username ?? old('username') }}" placeholder="{{ Auth::user()->username }}" required autocomplete="off" autofocus>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="password_old" type="password" class="form-control {{ !$errors->any() ?: 'is-invalid' }}" name="password_old" required>
                            </div>
                        </div>
